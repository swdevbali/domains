...
const sayHelloAsyncRequest = createAction(SAY_HELLO_ASYNC_REQUEST)
const sayHelloAsyncSuccess = createAction(SAY_HELLO_ASYNC_SUCCESS)
const sayHelloAsyncFailure = createAction(SAY_HELLO_ASYNC_FAILURE)
